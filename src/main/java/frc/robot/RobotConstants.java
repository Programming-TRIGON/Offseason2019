...
public class RobotConstants {
    ...
    public static class MotionProfiling {
        ...
        public static final PidSettings MOTION_PROFILING_PID_SETTINGS_LEFT = new PidSettings(/*0.972*/0, /*0.335*/0, 2.37, 0.309);
        public static final PidSettings MOTION_PROFILING_PID_SETTINGS_RIGHT = new PidSettings(/*1.14*/0, /*0.434*/0, 2.35, 0.309);// 0.1929, 2.5147
